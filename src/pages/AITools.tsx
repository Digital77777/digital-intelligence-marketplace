            ...
            <div className="space-y-6">
              <div className="p-6 bg-muted/50 rounded-lg border">
                ...
                <p className="text-muted-foreground mb-4">
                  You're currently on the Freemium plan, which gives you access to a limited selection of AI tools.
                </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="p-6 rounded-lg border bg-card hover:shadow-md transition-shadow">
                    <h3 className="text-lg font-medium mb-2">AI Tool {i}</h3>
                    <p className="text-sm text-muted-foreground mb-4">
                      A description of what this AI tool does and how it can help you.
                    </p>
